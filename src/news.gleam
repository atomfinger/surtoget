...
pub fn get_news_articles() -> List(NewsArticle) {
  let articles = [
    ...
    NewsArticle(
      ...
      external_image_url: "https://g.acdn.no/obscura/API/dynamic/r1/ece5/tr_2000_2000_s_f/1766132143000/teav/2025/12/19/9/5_50_1912827%2BOppr%25C3%25B8r%2Bi%2Bfjor.JPG?chk=D1976B",
      owner: "TA",
      date: "03. mars 2026",
    ),
    NewsArticle(
      ...
      external_image_url: "https://gfx.nrk.no/3koXqb7ue_H11x4TPrqPsQjrYBUHu5qmP21wa3vMCSPg",
      owner: "NRK",
    ...
    NewsArticle(
      ...
      external_url: "https://www.nrk.no/rogaland/halvparten-av-sorlandsbanen-er-innstilt-i-dag-1.17787230",
      external_image_url: "",
      owner: "NRK",
    ...
    NewsArticle(
      ...
      description: "Jernbanedirektoratet har svart på spørsmål fra Telemark fylkeskommune og berørte kommuner langs Sørlandsbanen. Ordfører i Drangedal, Stina A. Sætre (Sp) er ikke imponert.",
    ...
    NewsArticle(
      ...
      description: "Mangelen på togsett på Sørlandsbanen gjør at driftsselskapet Go-Ahead forteller om mange innstilte tog på strekningen mellom Stavanger og Oslo.",
    ...
    NewsArticle(
      ...
      description: "Ni planlagte togturer på Sørlandsbanen mellom Oslo, Kristiansand og Stavanger er avlyst fredag på grunn av problemer med togene og arbeid på togskinnene.",
    ...
    NewsArticle(
      ...
      description: "Vedlikeholdsarbeid og buss for tog på Sørlandsbanen skaper store utfordringer for pendlere i Lunde. For Claus Sohn Andersen fra Lunde har usikker togdrift gjort arbeidshverdagen langt mer krevende.",
    ...
    NewsArticle(
      ...
      description: "Go-Ahead er i gang med omfattende vedlikehold av togsett på Sørlandsbanen. Selskapet lover normal drift til våren. – Vanskelig å tro på, sier passasjer.",
    ...
    NewsArticle(
      ...
      description: "På grunn av mye vedlikehold på togene vil det kuttes seks til syv daglige avganger på Sørlandsbanen. Da vil kun fire av åtte tog være i drift.",
